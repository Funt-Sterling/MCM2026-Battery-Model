...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{2cm}FIGURE 10: The Chatty vs Streaming Paradox\\[1em]
    \textbf{Emma (Chatter):} $\rule{0.3cm}{0.3cm}\rule{0.1cm}{0.1cm}\rule{0.3cm}{0.3cm}\rule{0.1cm}{0.1cm}\rule{0.3cm}{0.3cm}\rule{0.1cm}{0.1cm}\rule{0.3cm}{0.3cm}$ (never goes low)\\[0.5em]
    \textbf{Steve (Streamer):} $\rule{0.1cm}{0.1cm}\rule{2cm}{0.3cm}\rule{0.1cm}{0.1cm}$ (one efficient burst)\\[1em]
    \vspace{2cm}}}
